...
app.post('/api/register', (req, res) => {
    ...
    bcrypt.hash(derivedPassword, 10, (hErr, hash) => {
        ...
        db.run(
            `INSERT INTO ${table} (email, password, first_name, last_name, phone, parent_phone, role) VALUES (?, ?, ?, ?, ?, ?, ?)`,
            [derivedEmail, hash, first_name, last_name, phone || null, parent_phone || null, derivedUserType],
            function(err) {
                if (err) {

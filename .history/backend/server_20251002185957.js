...
app.get('/api/teacher/lectures', authenticateToken, (req, res) => {
...
app.post('/api/teacher/lectures', authenticateToken, (req, res) => {
  const teacherId = req.user.id;
...
// Update a lecture
app.put('/api/teacher/lectures/:id', authenticateToken, (req, res) => {

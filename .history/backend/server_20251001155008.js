...
app.post('/api/orders', authenticateToken, (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      // Insert order items
      const orderItemsQuery = 'INSERT INTO order_items (order_id, course_id, quantity, price) VALUES (?, ?, ?, ?)';
      
      courses.forEach(course => {
        db.run(orderItemsQuery, [orderId, course.id, course.quantity, course.price], (err) => {

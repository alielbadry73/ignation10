...
app.post('/api/register', (req, res) => {
    ...
    bcrypt.hash(derivedPassword, 10, (hErr, hash) => {
        ...
        db.run(
            `INSERT INTO ${table} (username, email, password, full_name, first_name, last_name, phone, parent_phone) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
            [derivedUsername, derivedEmail, hash, derivedFullName, first_name, last_name, phone || null, parent_phone || null],
            function(err) {
                if (err) {

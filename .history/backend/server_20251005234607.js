...
app.post('/api/register', (req, res) => {
    ...
    bcrypt.hash(derivedPassword, 10, (hErr, hash) => {
        ...
        const sql = `INSERT INTO ${table} (email, password, first_name, last_name, phone, role) VALUES (?, ?, ?, ?, ?, ?)`;
        const params = [derivedEmail, hash, first_name || 'Unknown', last_name || 'User', phone || null, derivedUserType];

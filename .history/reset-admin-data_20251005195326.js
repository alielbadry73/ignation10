...
const db = new sqlite3.Database(dbPath, (err) => {
    ...
    async function clearAllTables() {
        try {
            ...
            console.log('✅ All teacher data cleared');
            console.log('✅ All assignment submissions cleared');
            console.log('✅ All quiz submissions cleared');
            console.log('✅ All password resets cleared');
            console.log('✅ All parent/student relationships cleared');
